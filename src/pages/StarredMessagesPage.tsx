                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                    ...
                    <Box>
                        ...
                        <Typography variant="body2" sx={{ fontFamily: montserrat, color: 'text.secondary' }}>
                            Messages you archived with a star — latest first
                        </Typography>
                    </Box>
                </Box>
                    ...
                    >
                        {messages.map((msg: any) => {
                            ...
                            const avatarSrc = msg.sender?.profilePicture
                                ? `http://localhost:5002${msg.sender.profilePicture}`
                                : undefined;
                                        ...
                                        <Box sx={{ flex: 1, minWidth: 0 }}>
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    >
                                                        {msg.content ?? (msg.caption ? `[${msg.caption}]` : '[Media]')}
                                                    </Typography>
                                                ...
                                                {/* Right column: small star icon + optional actions */}
