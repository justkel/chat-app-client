...
const SelectedMessagesBar: React.FC<SelectedMessagesBarProps> = ({
  ...
  return (
    <div className="bg-white p-4 shadow-md relative h-full flex flex-col z-20"> 
      <div className="fixed top-0 left-14 right-0 lg:left-[45.5%] xl:left-[43.5%] xxl:left-[42.9%] bg-white p-4 shadow-md flex items-center justify-between gap-y-4 gap-x-4">
